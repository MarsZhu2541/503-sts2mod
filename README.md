...
- [x] 加自己力量，敏捷 6及以上判定
- [x] 我和你赌命 判定扣除自身还是目标
- [x] 能力牌 若最大奖池数达到10 战斗结束后额外获得10金币
- [x] 能力牌 若最大奖池数达到20 战斗结束后额外获得一次卡牌奖励
- [x] 能力牌 若最大奖池数达到30 战斗结束后额外获得一次遗物奖励
- [x] 技能牌 本回合骰子不会出现点数1 消耗
- [x] 技能牌 费用0 给予某位队友1点能量 点数>5 给予2点 点数=1 扣队友1点
- [x] 技能牌 费用0 获得1点能量 点数>5 所有人获得1点能量 点数=1 扣自己1费