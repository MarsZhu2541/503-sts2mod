...
public class JackpotRelic : ModCardTemplate
{
    ...
    public JackpotRelic() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }

    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        await PowerCmd.Apply<JackpotRelicPower>(
            choiceContext,
