...
public class GainPricePool : ModCardTemplate
{
    // 基础耗能
    ...
    {
        await PowerCmd.Apply<PricePool>(choiceContext, cardPlay.Card.Owner.Creature, DynamicVars.Cards.BaseValue, cardPlay.Card.Owner.Creature, null);
    }
