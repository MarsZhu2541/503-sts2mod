...
public class DiceStrength : ModCardTemplate
{
    // 基础耗能
   ...
   private const CardType type = CardType.Skill;
    ...
    public override CardAssetProfile AssetProfile => new(
        PortraitPath: $"res://Mod503/images/cards/DiceStrength.png"
    );
    ...
    public DiceStrength() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
