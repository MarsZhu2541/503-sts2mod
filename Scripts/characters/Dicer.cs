...
[RegisterCharacter]
public sealed class Dicer : ModCharacterTemplate<DicerCardPool, DicerRelicPool, DicerPotionPool>
{
    ...
    private const string RestSiteScenePath = $"{SceneRoot}/Dicer_rest_site.tscn";
    private const string CharacterSelectBgScenePath = $"{SceneRoot}/Dicer_character_select_bg.tscn";
